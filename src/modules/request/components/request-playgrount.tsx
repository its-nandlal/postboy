...
import SaveRequsetToCollectionModal from '@/modules/collections/components/add-request-model'

const RequestPlaygrount = () => {
    ...
    useHotkeys("ctrl+g, meta+shift+n", (e)=>{
      e.preventDefault();
      e.stopPropagation();
      addTab();
...
export default RequestPlaygrount
